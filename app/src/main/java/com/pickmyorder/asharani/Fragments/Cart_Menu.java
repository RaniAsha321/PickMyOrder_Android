...
public class Cart_Menu extends Fragment implements MyInterface {
    ...
    private com.pickmyorder.asharani.Storage.databaseSqlite databaseSqlite;
    Cart_Menu cart_menu;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        home_activity.layout_banner.setVisibility(View.GONE);
        ...
        Continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!((business_id.equals(whichbusiness)))){
                    ...
                    Log.e("steps_tab_type",tab_type+"");

                    if (((tab_type != null) && !tab_type.equals("1"))) {
