...
public interface ApiLogin_Interface {
    ...
    Call <ModelProductsSubCategory> PRODUCTS_SUB_CATEGORY_CALL(@Field("catid") String catid,@Field("isVan") String isVan);

    @FormUrlEncoded
    @POST("getproductsupersubcategory")
    Call<ModelProductsSubSubCategory> PRODUCTS_SUB_SUB_CATEGORY_CALL(@Field("subcat") String subcat,@Field("isVan") String isVan);

    @FormUrlEncoded
    @POST("getproducts")
    Call<ModelDescription> PRODUCT_DESCRIPTION_CALL(@Field("supersubcat") String supersubcat, @Field("keystatus") String keystatus,@Field("isVan") String isVan);
