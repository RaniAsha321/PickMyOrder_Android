...
import com.pickmyorder.asharani.Adapters.Adapter_Add_project;
import com.pickmyorder.asharani.Adapters.Adapter_Update_project;
...
import com.pickmyorder.asharani.util.MultiSelectionSpinner;
...
public class Project_details_add_project extends AppCompatActivity implements MultiSelectionSpinner.OnMultipleItemsSelectedListener {
    ...
    public static TextView tv_drop_assign_eng;
