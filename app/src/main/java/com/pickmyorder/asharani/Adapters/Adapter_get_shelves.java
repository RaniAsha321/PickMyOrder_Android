...
import com.pickmyorder.asharani.Fragments.Catalogue_Promo_Images;
import com.pickmyorder.asharani.Models.Cetalouge;
...
public class Adapter_get_shelves extends RecyclerView.Adapter<Adapter_get_shelves.ViewHolder> {
    ...
    public Adapter_get_shelves(Context context, List<Shelvesdatum> mlist) {
    ...
    @NonNull
    @Override
    public Adapter_get_shelves.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_get_shelves.ViewHolder holder, int position) {
      ...
      //  Glide.with(mcontext).load("https://app.pickmyorder.co.uk/images/cetalogues/18529857541617281088").into(holder.CoverImage);
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // catlist = mlist.get(position).getCetalouge();
